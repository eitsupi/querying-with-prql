...
- [PRQL](https://prql-lang.org/) is a modern language for data manipulation that compiles to SQL.
  Although the PRQL language is still evolving, it is easy to create complex SQL queries. 
- [DuckDB](https://duckdb.org/) is a modern in-memory ([very fast](https://duckdblabs.github.io/db-benchmark/))
  SQL OLAP database management system.
  DuckDB is also evolving, with new features and improving syntax.

This project combines PRQL and DuckDB
to give a powerful database that can be queried with a simple syntax.
